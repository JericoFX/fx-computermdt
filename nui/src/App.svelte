<script lang="ts">
	...
	useNuiEvent(
		"openTablet",
		({ isvisible, defaultLang, onduty, userdata, type, langs }) => {
			open = isvisible;
			types = type;
			$UserInfo = userdata;
...
{#if open && $isLocaleLoaded === true}
	<img
		transition:fade
		src={types === "pc" ? "iconos/background.png" : "iconos/car.png"}
		class="absolute-center"
		style:width="72.39vw"
		style:height="88.55vh"
		style:top="51.5%"
		alt=""
		srcset=""
	/>
	<div
		transition:fade
		class="background  non-selectable absolute-center"
		style:width="66.66vw"
		style:height="74.92vh"
	>
		<!-- <Home /> -->
