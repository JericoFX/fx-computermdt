...
{#if active}
	<div
		...
		class="window absolute-bottom-right"
		style="bottom:7%;height:auto"
	>
		<div class="window-body">
			{#each $Langs as lang}
				<div class="field-row">
					<button
						on:click|preventDefault={() => changeLang(lang.index)}
					>
						{lang.lang}</button
					>
				</div>
